...
roger_pfaeffli = Programmer(
    first_name="Roger",
    last_name="Pfaeffli",
    gender="M",
    nationality="Swiss",
    famous_for="Knowing Nothing"
)
...
# deleting a singel record by primary key
# programmer = session.query(Programmer).filter_by(id=2).first()
# session.delete(programmer)
# session.commit()

# deleting a single record by prompting and searching over name
